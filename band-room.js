...
(function () {
  ...
  function makeGuitar(target) {
    ...
    guitar.maxPolyphony = 10;  // v199: was 6 — too low for strummed power chords
  ...
  function makeChordSynth(target) {
    ...
    chord.maxPolyphony = 10;  // v199: was 6 — too low for overlapping 4-note pads
    return chord;
  }
  ...
  function guitarAgentPlan(ctx) {
    ...
    if (ctx.role === "outro") {
      ...
      // v199: 8th-note strum (was 16th). 16 power-chord triggers per bar

# Cross-App Integrity — Music Stack 全体の整合性チェック (v167 時点)
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-73` / `band-room.js?v=br-84` | hazama-fm-v167 |
...
| doc | カバー範囲 | 整合状態 |
|-----|----------|--------|
| `BAND-ROOM-MANUAL.md` | Band Room 入り口 | v167 default mix polish / AI part agents / timeline 反映済 |
| `BAND-ROOM-CHANGELOG.md` | v65-v167 compact | 近年履歴は compact 追記で同期 |
...
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v167 cache map |

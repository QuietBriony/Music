# Cross-App Integrity — Music Stack 全体の整合性チェック (v171 時点)
...
Hazama FM / Music Core Rig / Band Room はそれぞれ別 manifest。Band Room は
v171 以降 `manifest-band-room.webmanifest` で installable にする。

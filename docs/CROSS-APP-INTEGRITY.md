# Cross-App Integrity — Music Stack 全体の整合性チェック (v153 時点)
...
v142-v153 で、FM の phrase-lock / pattern variation / genre handoff / 40Hz focus / 長時間 event quieting / start-stop hardening / bridge health fallback と、Band Room の車載 audio bridge / route status / bridge health fallback / album-flow default playback / lock-screen album transport が追加済み。
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-70` / `band-room.js?v=br-74` | hazama-fm-v153 |
| Hazama FM | `engine.js?v=fm-79` / `fm.css?v=fm-47` / `fm.js?v=fm-59` | 同上 |
| Music Core Rig | `engine.js?v=fm-79` / `style.css?v=fm-27` | 同上 |
...
| `BAND-ROOM-CHANGELOG.md` | v65-v153 compact | 近年履歴は compact 追記で同期 |
...
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v153 cache map |

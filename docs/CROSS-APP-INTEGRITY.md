# Cross-App Integrity — Music Stack 全体の整合性チェック (v166 時点)
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-73` / `band-room.js?v=br-83` | hazama-fm-v166 |
...
| doc | カバー範囲 | 整合状態 |
|-----|----------|--------|
| `BAND-ROOM-MANUAL.md` | Band Room 入り口 | v166 AI part agents / timeline 反映済 |
| `BAND-ROOM-CHANGELOG.md` | v65-v166 compact | 近年履歴は compact 追記で同期 |
...
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v166 cache map |

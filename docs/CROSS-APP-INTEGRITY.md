# Cross-App Integrity — Music Stack 全体の整合性チェック (v160 時点)
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-71` / `band-room.js?v=br-78` | hazama-fm-v160 |
...
| doc | カバー範囲 | 整合状態 |
|-----|----------|--------|
| `BAND-ROOM-MANUAL.md` | Band Room 入り口 | v160 主要機能反映済 |
| `BAND-ROOM-CHANGELOG.md` | v65-v160 compact | 近年履歴は compact 追記で同期 |
...
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v160 cache map |

# Cross-App Integrity — Music Stack 全体の整合性チェック (v169 時点)
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-73` / `band-room.js?v=br-85` | hazama-fm-v169 |
| Hazama FM | `engine.js?v=fm-83` / `fm.css?v=fm-50` / `fm.js?v=fm-64` | 同上 |
| Music Core Rig | `engine.js?v=fm-83` / `style.css?v=fm-28` | 同上 |
...
| `BAND-ROOM-CHANGELOG.md` | v65-v169 compact | 近年履歴は compact 追記で同期 |
...
| `HAZAMA-FM-ARCHITECTURE.md` | 全体アーキ | v169 の melodic director / phrase / focus / bridge 反映済 |
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v169 cache map |

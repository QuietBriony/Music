# Cross-App Integrity — Music Stack 全体の整合性チェック (v170 時点)
...
|-----|---------------------|------------|
| Band Room | `band-room.css?v=br-73` / `band-room.js?v=br-85` | hazama-fm-v170 |
...
| `BAND-ROOM-CHANGELOG.md` | v65-v170 compact | 近年履歴は compact 追記で同期 |
...
| `CROSS-APP-INTEGRITY.md` | **このファイル** | 整合性 hub / v170 cache map |

...
| 次に何を見るか決める | [OpenClaw Desk](https://quietbriony.github.io/openclaw/) | latest SYNC を読み、行き先と次PR候補を見る |
...
| OpenClaw Desk | Surface用の制作卓 / ハブ | latest SYNC、packet inspector、repo harvest | 候補と手順を出すだけ |
...
3. Music画面の `次の行き先` か OpenClaw Desk を見る。
4. 必要な repo だけ開く。
...
- [OpenClaw Desk](https://quietbriony.github.io/openclaw/)

## 安全境界

- Music Stack OpenClaw Desk は Umbrel 常駐 runtime ではありません。
- OpenClaw は音を鳴らさず、手順と候補を出す制作卓です。

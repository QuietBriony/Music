...
- Confirm cache markers match exactly across `fm.html`, `index.html`,
  ...
  `style.css?v=fm-28`, `band-room.css?v=br-83`,
  `band-room.js?v=br-183`, `audio/audio-safety.js?v=br-66`,
  `manifest-band-room.webmanifest?v=br-icon-1`, and `hazama-fm-v309`.
...
- If Band Room changed in the same PR, also confirm `band-room.css?v=br-83`,
  `band-room.js?v=br-183`, `audio/audio-safety.js?v=br-66`, and

...
- Confirm cache markers match exactly across `fm.html`, `index.html`,
  ...
  `engine.js?v=fm-117`, `fm.css?v=fm-53`, `fm.js?v=fm-70`,
  `audio/genre-flavor.js?v=fm-75`, `audio/ai-fills.js?v=fm-71`,
  `style.css?v=fm-28`, `band-room.css?v=br-84`,
  `band-room.js?v=br-199`, `audio/audio-safety.js?v=br-67`,
  `manifest-band-room.webmanifest?v=br-icon-1`, and `hazama-fm-v332`.
...
- If Band Room changed in the same PR, also confirm `band-room.css?v=br-84`,
  `band-room.js?v=br-198`, `audio/audio-safety.js?v=br-67`, and

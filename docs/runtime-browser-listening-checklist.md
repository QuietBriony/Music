...
- Confirm cache markers match exactly across `fm.html`, `index.html`,
  ...
  `band-room.js?v=br-186`, `audio/audio-safety.js?v=br-67`,
  `manifest-band-room.webmanifest?v=br-icon-1`, and `hazama-fm-v313`.
...
- If Band Room changed in the same PR, also confirm `band-room.css?v=br-83`,
  `band-room.js?v=br-186`, `audio/audio-safety.js?v=br-67`, and

...
2026-09-19追記: [ブラウザ制作台の推奨設計](BROWSER-WORKBENCH-DESIGN.md)で、
既存素材の再開・stem編集・コード／画面／チャットの共通sessionを先に整える方針を定義した。
本書はそのevent編集面の詳細。BL-049の素材・版保存を土台にBL-045へ進む。
8小節は最初の編集窓であり、元素材の異なる周期を丸める仕様ではない。

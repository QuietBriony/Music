...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-201-guitar-rhythm", "Band Room should expose the current guitar-rhythm version");
...
assert.match(html, /band-room\.js\?v=br-201/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-201/, "Service worker should precache the current Band Room JS marker");

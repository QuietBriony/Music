...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-179-vocal-present", "Band Room should expose the current vocal-present version");
...
assert.match(html, /band-room\.js\?v=br-179/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-179/, "Service worker should precache the current Band Room JS marker");

...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-215-master-gate", "Band Room should expose the current master-gate fix version");
...
assert.match(html, /band-room\.js\?v=br-215/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-215/, "Service worker should precache the current Band Room JS marker");

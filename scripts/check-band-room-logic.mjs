...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-214-audio-fix", "Band Room should expose the current audio-load fix version");
...
assert.match(html, /band-room\.js\?v=br-214/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-214/, "Service worker should precache the current Band Room JS marker");

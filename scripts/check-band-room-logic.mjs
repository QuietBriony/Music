...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-213-drum-rr", "Band Room should expose the current drum-rr version");
...
assert.match(html, /band-room\.js\?v=br-213/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-213/, "Service worker should precache the current Band Room JS marker");

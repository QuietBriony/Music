...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-226-hazama-hidden-band", "Band Room should expose the current app version (v367 HAZAMA chord depth)");
...
assert.match(html, /band-room\.js\?v=br-226/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-226/, "Service worker should precache the current Band Room JS marker");

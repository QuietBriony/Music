...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-231-arp-pluck", "Band Room should expose the current playability-entry app version");
...
assert.match(html, /band-room\.js\?v=br-231/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-231/, "Service worker should precache the current Band Room JS marker");

...
assert.equal(migratedMixPrefs.mixPrefsVersion, "v254-default-parts", "Migrated prefs should record current mix version");
...
assert.match(source, /const MIX_PREFS_VERSION = "v254-default-parts"/, "Band Room should version saved mix defaults");

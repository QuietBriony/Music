...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-224-hazama-hidden-band", "Band Room should expose the current app version (v365 HAZAMA hidden band)");
...
assert.match(html, /band-room\.js\?v=br-224/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-224/, "Service worker should precache the current Band Room JS marker");

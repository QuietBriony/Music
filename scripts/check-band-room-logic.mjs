...
assert.equal(windowMock.BandRoomTestHooks?.BANDROOM_APP_VERSION, "br-225-hazama-hidden-band", "Band Room should expose the current app version (v366 HAZAMA engine port)");
...
assert.match(html, /band-room\.js\?v=br-225/, "Band Room HTML should reference the current JS cache marker");
...
assert.match(sw, /band-room\.js\?v=br-225/, "Service worker should precache the current Band Room JS marker");
